...
class ErrorCode4(Error):
    ...
    def __init__(self, suppress):
        ...
        Please consider to relax the thresholds before rerun piemmer.harvest

        After successful run piemmer.harvest, you can use the "RevisitThreshold" mode in
        piemmer.bake to refine theshold selection
        """
        return(suppress)
...
class ErrorCode8(Error):
    ...
    def __init__(self, suppress):
        ...
        [[Error code 8]]
        Parameter setting error:
        Expect a piemmer.harvest-gereated csv file.
...
class ErrorCode9(Error):
    ...
    def __init__(self, suppress):
        ...
        [[Error code 9]]
        Parameter setting error:
        Expect a piemmer.harvest-gereated csv file that contain percent explain information
        for each PC.
        """
        return(suppress)
...
class ErrorCode10(Error):
    ...
    def __init__(self, suppress):
        ...
        For example, this error will arise when piemmer.bake ask the user to define color for
...
class ErrorCode11(Error):
    ...
    def __init__(self, suppress):
        ...
        If you are using a piemmer.harvest output file, please consider to relax
        your information-rich feature choosing thresholds. You can also run
        'RevisitThreshold' mode in piemmer.bake to select a better threshold settings.
        """
        return(suppress)
...
class ErrorCode12(Error):
    ...
    def __init__(self, suppress):
        ...
        after running 'Bifurication' mode in piemmer.bake
        """
        return(suppress)
...
class ErrorCode16(Error):
    ...
    def __init__(self, suppress):
        ...
        PCA coordinate. This file is generated by piemmer.harvest when set -n as True.
...
class ErrorCode24(Error):
    ...
    def __init__(self, suppress):
        ...
        piemmer except a number that is greater than zero.

        Example:
            -u '3,1,1'

        For the example above, piemmer.bake will test three different -u setting:
        1, 2, and 3
        """
        return(suppress)
...
class ErrorCode25(Error):
    ...
    def __init__(self, suppress):
        ...
        The thrid element in arguments -u, -l, and -t represents the increment.
        Base on your setting of the first and the second elements in this argument,
        piemmer except a number that is less than the first elements.
...
class ErrorCode26(Error):
    ...
    def __init__(self, suppress):
        ...
        The thrid element in arguments -u, -l, and -t represents the increment.
        Base on your setting of the first and the second elements in this argument,
        piemmer except a number that equals to zero.
...
class ErrorCode27(Error):
    ...
    def __init__(self, suppress):
        ...
        Suggestion:
            ...
            when user first run piemmer.harvest
        """
        return(suppress)
...
class ErrorCode30(Error):
    ...
    def __init__(self, suppress):
        ...
        piemmer.bake. The program will guild you through the process and prepare a -p file for your
        future analysis.

        Example:
            python3 -m piemmer.bake -m 'Individual' -i <filtered_infoRich__PCA_coordinates.csv>
            python3 -m piemmer.bake -m 'Permanova' -i <filtered_infoRich__PCA_coordinates.csv>
            python3 -m piemmer.bake -m 'Reproducibility' -b 20 -i <information_rich_features_summary.csv>
            python3 -m piemmer.bake -m 'RevisitThreshold' -u <2.5,1.5,0.25> -l <2.5,1.5,0.25> -e <output/detail_vNE/> -i <output/filtered_data/>
            python3 -m piemmer.bake -m 'Bifurication' -i <filtered_data/> -p <information_rich_features_summary.csv>


        Group:
            Expect a csv file that has ['group'] as column names. In piemmer.bake, the row of the
            input matrix represent each individual in each original input file for piemmer. 'Group'
        ...
        Individaul
            ...
            input matrix represent each individual in each original input file for piemmer. 'individual'
...
class ErrorCode32(Error):
    ...
    def __init__(self, suppress):
        ...
        [[Error code 32]]
        Parameter setting error:
        Expect a single csv file that contains PCA coordinate generated by piemmer.harvest
...
class ErrorCode34(Error):
    ...
    def __init__(self, suppress):
        ...
        This file is generated by piemmer.harvest
...
class ErrorCode35(Error):
    ...
    def __init__(self, suppress):
        ...
        Parameter setting error:
        Expect a single csv file that contains information for scaling the data matrix for calculating the
        PCA coordinate. This file is generated by piemmer.harvest
...
class ErrorCode38(Error):
    ...
    def __init__(self, suppress):
        ...
        Having "__" will interfere with piemmer.harvest and piemmer.bake data handling
...
class ErrorCode39(Error):
    ...
    def __init__(self, suppress = False):
        ...
        Having "__" will interfere with piemmer data handling

        Please refer to /data/data_dir_3/group_A.csv as example for
        piemmer.harvest input file
        """
        return(suppress)
...
class ErrorCode43(Error):
    ...
    def __init__(self, suppress):
        ...
        Example:
            ...
            DATA_PATH
            exit
            cd DATA_PATH/data/data_dir_3
            vi DATA_PATH/data/data_dir_3/group_A.csv
        """
        return(suppress)
...
class ErrorCode44(Error):  # TODO need unittest
    ...
    def __init__(self, suppress):
        """
        [[Error code 44]]
        Log file already exist; raise error and stop piemmer to avoid accidently remove
        previous log file without knowing.

        To prevent this error when running multiple piemmer analyses in parallele, please
